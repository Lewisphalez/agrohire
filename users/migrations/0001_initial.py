    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('farmer', 'Farmer'), ('equipment_owner', 'Equipment Owner'), ('admin', 'Admin')], default='farmer', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('farm_type', models.CharField(blank=True, choices=[('crop', 'Crop Farming'), ('livestock', 'Livestock Farming'), ('mixed', 'Mixed Farming'), ('horticulture', 'Horticulture'), ('other', 'Other')], max_length=50, null=True)),
